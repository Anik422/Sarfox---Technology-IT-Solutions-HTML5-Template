(function ($) {
	...
	new WOW().init();		
	// /*========== Responsive Menu  ==========*/
	$('.header-area-menubar-main-menu').meanmenu({
	...
	$(window).on('scroll', function () {
		...
		if (scrollDown < 135) {
			$(".header-area-menubar-area").removeClass("header-area-menubar-area-sticky-menu");
		} else {
			$(".header-area-menubar-area").addClass("header-area-menubar-area-sticky-menu");
		}
	});
	/*==========  counterUp  ==========*/
	var counter = $('.counter');
	...
	/*==========  Search  =========*/
	$('.header-area-menubar-right-search-icon.open').on('click', function () {
		$('.header-area-menubar-right-search-box').fadeIn().addClass('active');
	});
	$('.header-area-menubar-right-search-box-icon').on('click', function () {
		$(this).fadeIn().removeClass('active');
	});
	$('.header-area-menubar-right-search-box-icon i').on('click', function () {
		$('.header-area-menubar-right-search-box').fadeOut().removeClass('active');
	});
	$('.header-area-menubar-right-search-box form').on('click', function (e) {
		e.stopPropagation();
	});
	// /*==========  sidebar popup  ==========*/
	...
	/*==========  Progress Bar  ==========*/  
	if($('.skilbar-area-bar').length) {
	  $('.skilbar-area-bar').appear(function(){
		  var el = $(this);
		  var percent = el.data('width');
		  $(el).css('width', percent+'%');
	  }, {accY: 0});
